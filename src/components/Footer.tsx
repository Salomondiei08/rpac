    ...
    <footer className="bg-primary text-primary-foreground py-12">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <p className="text-primary-foreground/80 text-sm">
              Votre partenaire de confiance pour l'énergie solaire en Côte d'Ivoire
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-primary-foreground/80">
              ...
              <li><a href="#kits" className="hover:text-accent transition-colors">Nos Kits</a></li>
        ...
        <div className="border-t border-primary-foreground/20 pt-8 text-center text-sm text-primary-foreground/60">
          <p>&copy; {new Date().getFullYear()} Mienssa Energy. Tous droits réservés.</p>
        </div>
      </div>
    </footer>
  );
